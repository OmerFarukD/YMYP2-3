...
public  class Repository
{
    ...
    public static List<Product> Products = new List<Product>
    {
        ...
        new Product{Id=7,Name="Arçelik Süpürge 3",CategoryName="Ev Aletleri",Price=3250,Stock=63},
        new Product{Id=4, Name="Dyson Süpürge 1",CategoryName="Ev Aletleri",Price=15000,Stock=120},
